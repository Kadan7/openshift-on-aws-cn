...
aws s3 mb s3://${CLUSTER_NAME}-${InfrastructureName}-cn-northwest-1

aws s3 cp ${CLUSTER_NAME}/bootstrap.ign s3://${CLUSTER_NAME}-${InfrastructureName}-cn-northwest-1/bootstrap.ign
